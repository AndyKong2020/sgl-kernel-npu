#ifndef HEADER_ACLRTLAUNCH_CAUSAL_CONV1D_FLA_PREFILL_HALF_H
#define HEADER_ACLRTLAUNCH_CAUSAL_CONV1D_FLA_PREFILL_HALF_H
...
extern "C" uint32_t aclrtlaunch_causal_conv1d_fla_prefill_half(
