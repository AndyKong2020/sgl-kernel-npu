#ifndef HEADER_ACLRTLAUNCH_CAUSAL_CONV1D_FLA_PREFILL_BFLOAT16_T_H
#define HEADER_ACLRTLAUNCH_CAUSAL_CONV1D_FLA_PREFILL_BFLOAT16_T_H
...
extern "C" uint32_t aclrtlaunch_causal_conv1d_fla_prefill_bfloat16_t(
